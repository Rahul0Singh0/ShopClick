...
function MyState(props) { //create a function
    ...
    const getProductData = async () => {
        ...
        try {
            const q = query(
                ...
                orderBy('time')//product display depends on its adding time
            );
    ...
    const deleteProduct = async(item) =>{
        setLoading(true)
        try{
            await deleteDoc(doc(fireDB, 'products', item.id))//Database name is fireDB and collection name is products
    ...
    return (
        // multiple data pass as an object in curly bracket
